...
// LoadSettings attempts to load settings from "settingsV1.json"
func LoadSettings() (*AppSettings, error) {
	data, err := os.ReadFile("settingsV1.json")
	if err != nil {
		return nil, err
	}
...
// SaveSettings serializes settings to "settingsV1.json"
func SaveSettings(settings *AppSettings) error {
	data, err := json.MarshalIndent(settings, "", "  ")
	if err != nil {
		return err
	}
	return os.WriteFile("settingsV1.json", data, 0644)
}
